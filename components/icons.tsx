...
export const RefreshIcon: React.FC<IconProps> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M4 4v5h5M5.291 19.291A10 10 0 105.29 4.708" />
  </svg>
);
...
export const EnhanceIcon: React.FC<IconProps> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.293 2.293c.63.63 1.707.63 2.337 0l2.293-2.293m-4.63 17.636l2.293-2.293c.63-.63 1.707-.63 2.337 0l2.293 2.293M17 6l2.293-2.293c.63-.63 1.707-.63 2.337 0L24 6M12 21l2.293-2.293c.63-.63 1.707-.63 2.337 0L19 21M3 12h4m14 0h-4" />
    </svg>
);
...
export const AddAsSourceIcon: React.FC<IconProps> = (props) => (
...
export const WorkflowIcon: React.FC<IconProps> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" d="M10.5 6a7.5 7.5 0 100 12h-3a7.5 7.5 0 00-7.5-7.5h1.5v-3h1.5a7.5 7.5 0 007.5-7.5v-3h3a7.5 7.5 0 007.5 7.5h-1.5v3h-1.5a7.5 7.5 0 00-7.5 7.5v3h-3a7.5 7.5 0 000-12zM3 10.5h1.5v3H3v-3z" />
  </svg>
);
...
export const FilmIcon: React.FC<IconProps> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M7 4v16M17 4v16M3 8h4m0 8H3m18-8h-4m0 8h4M5 4h14a2 2 0 012 2v12a2 2 0 01-2 2H5a2 2 0 01-2-2V6a2 2 0 012-2z" />
  </svg>
);
...
export const DocumentTextIcon: React.FC<IconProps> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m0 12.75h7.5m-7.5 3h7.5m-7.5-3v-3m0 3h7.5M3.375 6A2.25 2.25 0 015.625 3.75h8.25c1.035 0 1.875.84 1.875 1.875v.25c0 .621.504 1.125 1.125 1.125h2.25c.621 0 1.125.504 1.125 1.125v6.75c0 .621-.504 1.125-1.125 1.125H9.375a1.125 1.125 0 01-1.125-1.125v-1.5c0-.621-.504-1.125-1.125-1.125H3.375c-.621 0-1.125-.504-1.125-1.125v-1.5A2.25 2.25 0 013.375 6z" />
    </svg>
);
...
export const FileExportIcon: React.FC<IconProps> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
...
export const StartFrameIcon: React.FC<IconProps> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M15 12H3m12 0-4-4m4 4-4 4M21 3v18" />
  </svg>
);

export const EndFrameIcon: React.FC<IconProps> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M9 12h12M9 12l4-4M9 12l4 4M3 3v18" />
  </svg>
);
