...
export const COMFYUI_WAN22_I2V_WORKFLOW_TEMPLATE = {
  ...
  "83": { "inputs": { "width": 848, "height": 560, "length": 65, "batch_size": 1, "end_frame_strength": 1.0, "positive": [ "6", 0 ], "negative": [ "7", 0 ], "vae": [ "39", 0 ], "clip_vision_start_image": [ "51", 0 ], "clip_vision_end_image": [ "87", 0 ], "start_image": [ "52", 0 ], "end_image": [ "72", 0 ] }, "class_type": "WanFirstLastFrameToVideo", "_meta": { "title": "WanFirstLastFrameToVideo" } },
