...
contextBridge.exposeInMainWorld('electron', {
    ...
    searchCivitaiArchive: (request) => ipcRenderer.invoke('search-civitai-archive', request),
    getCivitaiArchiveDetails: (request) => ipcRenderer.invoke('get-civitai-archive-details', request),
    downloadCivitaiArchiveModel: (request) => ipcRenderer.invoke('download-civitai-archive-model', request),
    ...
    setLocalModelCategory: (request) => ipcRenderer.invoke('set-local-model-category', request),
    ...
    fetchLocalModelHuggingFace: (request) => ipcRenderer.invoke('fetch-local-model-hugging-face', request),
