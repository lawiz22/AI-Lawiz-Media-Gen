...
const FEATURE_SPECS: FeatureSpec[] = [
    ...
    { group: 'Prompt', name: 'Prompt from Image', detail: 'Gemini, Mammouth, Ollama or ComfyUI Florence2 analysis.', paths: [
    ...
    { group: 'Fun', name: 'Past Forward via Gemini', detail: 'Cloud past/future transformation.', backend: 'gemini' },
